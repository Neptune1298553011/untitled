...
<!--                                                <div class="swiper-slide">-->
<!--                            <a class="link" href="#">-->
<!--                                <img src="../../php/image/statics/20.jpg">-->
<!--                            </a>-->
<!--                        </div>-->
<!--                                                <div class="swiper-slide">-->
<!--                            <a class="link" href="#">-->
<!--                                <img src="../../php/image/statics/21.jpg">-->
<!--                            </a>-->
<!--                        </div>-->
<!--                                                <div class="swiper-slide">-->
<!--                            <a class="link" href="#">-->
<!--                                <img src="../../php/image/statics/22.jpg">-->
<!--                            </a>-->
<!--                        </div>-->
                                            </div>
                    <!-- Add Pagination -->
                ...
                <ul class="share_list after">
                    <li class="share_item">
                        ...
                        <a class="icon weibo wb_share"
                            ...
                            data-pic="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://store.igg.com/m/product/100443.html"
    ...
    <li class="item topToBottom" data-goods_id="100456" >
        ...
        <a class="link" target="_blank" href="new4.php">
            <div class="img show_tag " style="" >
                <img style="" src="../../../../public/images/statics/29.jpg">
