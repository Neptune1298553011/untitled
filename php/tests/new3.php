...
<script>
    ...
    $(".collection_s_btn").click(function() {
        ...
        $.ajax({
            ...
            <script src="../../../../public/scripts/goods_detail.js"></script>
